...
@CompileStatic
class LessThanEquals extends LessThan implements Operation {
    /**
     ...
     */
    @Override boolean execute( String value1, String value2 ) {

        value1.equals( value2 ) | super.execute( value1, value2 )
    }
}
